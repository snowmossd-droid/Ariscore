...
public class AuctionConfigManager {
    ...
    public List<String> getAbbreviationFormats() {
        List<String> list = config.getStringList("economy.abbreviations.formats");
        if (list.isEmpty() && config.getDefaults() != null) {
            list = config.getDefaults().getStringList("economy.abbreviations.formats");
        }
        return list;
    }
    public List<String> getBlacklistItems() {
        List<String> list = config.getStringList("blacklist-items");
        if (list.isEmpty() && config.getDefaults() != null) {
            list = config.getDefaults().getStringList("blacklist-items");
        }
        return list;
    }
