...
public class TabProfile {
    ...
    public TabProfile(String id, String displayCondition, String world, List<String> header, List<String> footer, String tablistNameFormat) {
        this.id = id; this.displayCondition = displayCondition; this.world = world; this.header = header; this.footer = footer; this.tablistNameFormat = tablistNameFormat;
    }
